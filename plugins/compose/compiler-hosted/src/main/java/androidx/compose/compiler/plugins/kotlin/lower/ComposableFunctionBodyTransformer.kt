...
//                }
    ...
    override fun visitWhen(expression: IrWhen): IrExpression {
        ...
        forEachWith(transformed.branches, condScopes, resultScopes) { it, condScope, resultScope ->
            ...
            if (
                ...
                // the block has composable calls. The feature flag check here is redundant as this
                // needsBranchGroups will be true if any result scope has composable calls but it
                // is here so when this flag is turned on by then test will be removed too.
    ...
    sealed class Scope(val name: String) {
        ...
        abstract class BlockScope(name: String) : Scope(name) {
            ...
            fun markWrapped() { groupWrapped = true }
