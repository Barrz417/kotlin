...
enum class SomeEnum21(var x: Int) {
    A(1) {
        init {
            <!UNINITIALIZED_ENUM_ENTRY!>A<!>.x = 10 // K1: OK, K2: Error
            SomeEnum21.<!UNINITIALIZED_ENUM_ENTRY!>A<!>.x = 10 // K1: OK, K2: Error
...
enum class SomeEnum22(var x: Int) {
    A(1) {
        init {
            <!UNINITIALIZED_ENUM_ENTRY!>A<!>.x = 10 // K1: OK, K2: Error
            SomeEnum22.<!UNINITIALIZED_ENUM_ENTRY!>A<!>.x = 10 // K1: OK, K2: Error
...
enum class SomeEnum3(var x: Int) {
    ...
    B(2) {
        init {
            A.x = 10 // OK
            SomeEnum3.A.x = 10 // OK
            <!UNINITIALIZED_ENUM_ENTRY!>B<!>.x = 10 // K1: OK, K2: Error
            SomeEnum3.<!UNINITIALIZED_ENUM_ENTRY!>B<!>.x = 10 // K1: OK, K2: Error
        }
    };
}
